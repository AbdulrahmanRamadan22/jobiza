...
class SliverGridRecomentedJobs extends StatelessWidget {
  const SliverGridRecomentedJobs({
    super.key,
  });
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Facebook', style: TextStyles.font12Gray),
                    Text(r'$96,000/y', style: TextStyles.font12Black),
                  ],
                ),
              ),
            ),
